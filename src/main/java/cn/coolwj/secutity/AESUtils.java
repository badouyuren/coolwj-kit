...
public class AESUtils {
    ...
    /**
     * 解决java不支持AES/ECB/PKCS7Padding模式解密
     */
    static {
    ...
    public static void main(String[] args) throws Exception {
        String aa = "U2FsdGVkX1+j7i7ys5yNCYQCsby8swtBra7L1SvNCZkTytRNsI2Ivra1iZY3ycb+jIlHVkmE8t7/Ycgi1detyA==";
        String bb = Base64.getEncoder().encodeToString(aa.getBytes());
        System.out.println(bb);


        String key = "90d2efe6793e42419209afd0a4573fd4";
        String str = "90d2efe6793e42419209afd0a4573fd4";
        ...
        String cc = Base64.getEncoder().encodeToString(data);
        System.out.println(cc);


//        String res = encrypt(str.getBytes(), key.getBytes());
//        System.out.println(res);
//
//        res = new String(decrypt(res.getBytes(), key.getBytes()));
//        System.out.println(res);
//
//        str = "";
//        res = new String(decrypt(str.getBytes(), key.getBytes()));
//
//        System.out.println(res);
    }


    public static final String JS_ENCRYPT_CODE = """
                        
              var content = "90d2efe6793e42419209afd0a4573fd4";
                    
              const AES_KEY = "90d2efe6793e42419209afd0a4573fd4";
              ...
              var ciphertext = CryptoJS.enc.Base64.stringify(encryptResult.ciphertext);
              console.info(ciphertext);
                                
            """;

    private static final String JS_DECRYPT_CODE = """
                        
              var content = "90d2efe6793e42419209afd0a4573fd4";
              
              const AES_KEY = "90d2efe6793e42419209afd0a4573fd4";
              
              const encryptResult = CryptoJS.AES.decrypt(
                  CryptoJS.enc.Utf8.parse(content),
                  CryptoJS.enc.Utf8.parse(AES_KEY),
                  {
                      mode: CryptoJS.mode.ECB,
    ...
    public static final String CRYPTO_JS_CODE = """
            /*
            CryptoJS v3.0.2
